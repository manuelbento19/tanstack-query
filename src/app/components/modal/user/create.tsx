        ...
        <article className="relative z-[60] p-4 m-auto max-w-md w-full  bg-white rounded-lg shadow">
            ...
            <form className="px-4 py-2 flex flex-col gap-3">
                ...
                <div className="w-full">
                    ...
                    <input type="text" name="lastName" id="lastName" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required/>
                </div>
                <div className="w-full">
                    <label htmlFor="email" className="text-sm mb-1 text-slate-700">E-mail</label>
                    <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required/>
                </div>
